 ...
 * Author : Marty Stepp
 *
 * This file used to contain menus for testing other PQs like Heap and Vector,
 * but the assignment has changed, so this has been removed.
 */
...
void test(LinkedPriorityQueue& queue);
void bulkEnqueue(LinkedPriorityQueue& queue);
