...
int fillHelper (GBufferedImage& image, int x, int y, int curColor, int changeColor);
Vector<std::string> grammarGenerateHelper(HashMap<std::string,Vector<std::string>> lexicon, std::string symbol, int times);
#endif
